    ...
    <div>
      <div className="relative px-5 md:px-10 lg:px-20 pt-10 bg-primary h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 pt-60 items-center">
          <div>
            <h1 className="text-white font-normal text-5xl leading-[72px]">
        ...
        <div
          className="flex items-center justify-between mt-20 whitespace-nowrap overflow-x-scroll w-full py-10 relative"
          id="logos"
        >
      ...
      <div className="px-5 md:px-10 lg:px-20 py-20">
        ...
        <p className="text-5xl leading-[72px] lg:w-4/5 mx-auto text-center">
        ...
        <div className="my-20 grid grid-cols-1 md:grid-cols-2 items-center">
          ...
          <div className="w-3/4 mx-auto">
            ...
            <ul className="mt-10 mb-14">
              ...
              <li className="flex items-center gap-3 mb-6">
                <img src={check} alt="check" /> Advisor success customer launch
                party.
              </li>
              <li className="flex items-center gap-3">
                <img src={check} alt="check" /> Business-to-consumer long tail.
              </li>
            </ul>
      ...
      <div className="px-5 md:px-10 lg:px-20 py-20 bg-primary text-white">
        <div className="flex justify-between items-end">
          <p className="text-5xl leading-[72px] lg:w-3/5">
                ...
                <div>
                  ...
                  <div className="mt-6">
                    <div className="flex items-center gap-2 text-primary font-bold mb-3">
                      {category}{" "}
                      <span className="text-[#777777] font-normal">{date}</span>
                    </div>
      ...
      <div className="px-5 md:px-10 lg:px-20 py-20">
        <div className="relative bg-primary text-white py-20 rounded-2xl">
          ...
          />
          <p className="text-5xl leading-[72px] lg:w-3/5 mx-auto text-center">
            An enterprise template to ramp up your company website
          </p>
