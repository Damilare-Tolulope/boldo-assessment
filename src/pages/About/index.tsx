    ...
    <div>
      <div className="px-5 md:px-10 lg:px-20 bg-primary py-40 text-white">
        <div className="text-center w-3/4 mx-auto">
          ...
          <p className="text-6xl leading-[72px] lg:w-4/5 mx-auto text-center">
      ...
      <div className="px-5 md:px-10 lg:px-20 bg-primary py-20 text-white">
        ...
        <div className="flex items-center justify-between px-10">
          <div>
            <p className="text-[96px] text-[#4FE9A4]">120m</p>
            <p className="text-2xl text-[#F1F1F1]">Cool feature title</p>
          </div>
          <div>
            <p className="text-[96px] text-[#4FE9A4]">10.000</p>
            <p className="text-2xl text-[#F1F1F1]">Cool feature title</p>
          </div>
          <div>
            <p className="text-[96px] text-[#4FE9A4]">240</p>
            <p className="text-2xl text-[#F1F1F1]">Cool feature title</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-5 md:px-10 lg:px-20 py-20">
        <div className="lg:w-3/5 mx-auto">
          ...
          <p className="text-5xl leading-[72px] mx-auto">The leadership team</p>
        ...
        <div className="lg:w-3/5 mx-auto">
          ...
          <div className="mt-16">
            {values.map(({ title, desc, img }) => (
              <div className="flex items-start gap-12 mb-16" key={title}>
