  ...
  return (
    <footer>
        ...
        <div>
          ...
          <Link to={ABOUT} className="block cursor-pointer mb-4 text-lg text-[#777777]">
            Home
          </Link>
          <Link to={ABOUT} className="block cursor-pointer mb-4 text-lg text-[#777777]">
            Products
...
<h2 className="text-lg font-bold mb-8">Company</h2>
          ...
          <Link to={ABOUT} className="block cursor-pointer mb-4 text-lg text-[#777777]">
            Careers <span className="py-1 px-4 bg-[#65E4A3] text-primary text-[13px] font-bold rounded-full ml-2">Hiring!</span>
          </Link>
          <Link to={ABOUT} className="block cursor-pointer mb-4 text-lg text-[#777777]">
              Services
          </Link>
